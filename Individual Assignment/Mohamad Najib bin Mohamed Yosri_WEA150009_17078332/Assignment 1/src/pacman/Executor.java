...
{	
	...
	public static void main(String[] args)
	{
		...
		int numTrials=10;
		exec.runExperiment(new WibaPacManBT(),new StarterGhosts(),numTrials);
		
		int delay=10; // gamespeed delay
		boolean visual=true;
		//exec.runGame(new WibaPacManBT(),new StarterGhosts(),visual,delay);
		...
		*/
		...
		//boolean visual=true;
		//exec.runGameTimed(new WibaPacManBT(), new StarterGhosts(), visual); 
		//exec.runGameTimed(new WibaPacManMCTS(), new StarterGhosts(), visual); 
		//exec.runGameTimed(new WibaPacManMCTS(), new Legacy2TheReckoning(), visual);
		// */
